...
import {
  addPackagesAction as addPackagesActionImpl,
  simulatePackageUpdateAction as simulatePackageUpdateActionImpl,
  updatePackageSettingsAction as updatePackageSettingsActionImpl,
} from "@/lib/packages/package-actions";
import { sendTestApprisePackageAction as sendTestApprisePackageActionImpl } from "@/lib/packages/package-test-actions";
...
// ─── GHCR Package Actions ────────────────────────────────────────────────────

export async function addPackagesAction(
  ...args: Parameters<typeof addPackagesActionImpl>
) {
  return addPackagesActionImpl(...args);
}

export async function updatePackageSettingsAction(
  ...args: Parameters<typeof updatePackageSettingsActionImpl>
) {
  return updatePackageSettingsActionImpl(...args);
}

export async function simulatePackageUpdateAction(
  ...args: Parameters<typeof simulatePackageUpdateActionImpl>
) {
  return simulatePackageUpdateActionImpl(...args);
}

export async function sendTestApprisePackageAction(
  ...args: Parameters<typeof sendTestApprisePackageActionImpl>
) {
  return sendTestApprisePackageActionImpl(...args);
}
